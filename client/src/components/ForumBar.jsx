...
const ForumBar = (props) => {
    ...
    console.log(props)
    return (
        <div className={`bg-white ${props.className} rounded-lg h-16 mb-8 shadow-md shadow-slate-400 hover:shadow-none hover:border-2 hover:border-slate-100`} onClick={handleClick}>
