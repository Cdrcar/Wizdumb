    ...
    <div className="grid flex">
      ...
      <div className="grid place-items-center m-20">
        <form>
          ...
          <br></br>
          <button
            className="bg-sky-400 border rounded-full text-background text-center mb-2 hover:bg-white hover:text-sky-400 hover:cursor-pointer hover:border-sky-400 ml-6"
            style={{
              width: "150px",
              height: "36px",
            }}
