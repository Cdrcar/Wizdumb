...
const Signup = () => {
  ...
  return (
    <div className="bg-white border border-white rounded-md flex flex-col justify-center items-center">
      <div className="w-[320px] mb-[-50px]">
        <Logo />
      </div>
      <div className="grid place-items-center m-20">
        <div className="max-w-sm border items-center justify-center  border-gray-300 p-6">
          <h4 className="font-black text-cyan-700  text-center text-4xl mb-4 mt-10 mx-11">
            Sign up
          </h4>
          <h6 className="mb-10">
            Learn on your own time from the best courses
          </h6>
          {addUserResponse ? (
            <p>
